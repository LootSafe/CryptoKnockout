...
namespace TouchControlsKit.Inspector
{
    public abstract class ControllerBaseEditor : Editor
    {
        ...
        List<SerializedProperty> m_Events = new List<SerializedProperty>();
        ...
        void InitEvents()
        {
            m_Events.Add( serializedObject.FindProperty( "downEvent" ) );
            m_Events.Add( serializedObject.FindProperty( "pressEvent" ) );
            m_Events.Add( serializedObject.FindProperty( "upEvent" ) );
            m_Events.Add( serializedObject.FindProperty( "clickEvent" ) );
            m_Events.Add( serializedObject.FindProperty( "alwaysEvent" ) );
        }
        ...
        {
            TCKEditorHelper.LargeFoldout( updateModeProp, "Events", () =>
                m_Events.ForEach( e => EditorGUILayout.PropertyField( e ) ) );
        }
