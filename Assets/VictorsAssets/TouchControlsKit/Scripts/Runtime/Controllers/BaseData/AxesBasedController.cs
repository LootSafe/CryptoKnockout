...
namespace TouchControlsKit
{
    ...
    public abstract class AxesBasedController : ControllerBase
    {
        ...
        AxesAlwaysHandler alwaysHandler = ( x, y, tf ) => { };
        
        public AxesEvent 
            downEvent = new AxesEvent()
            , pressEvent = new AxesEvent()
            , upEvent = new AxesEvent()
            , clickEvent = new AxesEvent();

        public AlwaysAxesEvent alwaysEvent = new AlwaysAxesEvent();
        ...
        // Bind Action
        internal void BindAxes( AxesEventHandler handler, EActionEvent actionEvent )
        {
            switch( actionEvent )
            {
        ...
        // UnBind Action
        internal void UnBindAxes( AxesEventHandler handler, EActionEvent actionEvent )
        {
            switch( actionEvent )
            {
                case EActionEvent.Down:
        ...
        // UnBind Axes
        internal void UnBindAxes( AxesAlwaysHandler handler )
        {
